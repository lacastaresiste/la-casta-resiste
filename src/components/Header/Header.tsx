...
export const Header = () => {
	return (
		<header className="w-full shadow-md flex flex-col justify-center rounded-md items-center bg-navbar place-content-center p-4 border border-[#555]">
			...
			<div className="flex flex-row gap-2 items-center justify-center">
				...
				<h3 className="text-[0.8rem] text-center p-2 lg:p-0">
					<i className="text-white">
						aviso legal: el contenido en esta web es puramente de índole público
